          ...
          <div className="mx-auto max-w-7xl w-full grid md:grid-cols-[1.25fr_1fr] gap-16 md:gap-24 lg:gap-32 items-center">
            <div className="order-2 md:order-1 animate-fade-in">
              ...
              <p className="mt-6 text-xl md:text-2xl lg:text-3xl font-medium"
                ...
                FE Enthusiast <span style={{ color: 'var(--accent-cyan)' }}>•</span>{' '}
                Tech Explorer
              </p>
              <div className="mt-5 space-y-1 text-base md:text-lg leading-relaxed"
                ...
                <p>Currently Pursuing 3rd Year at</p>
                <p>
                  <span className="font-semibold" style={{ color: 'var(--accent-cyan)' }}>College of Engineering Guindy (CEG)</span>,{' '}
                  <span className="font-semibold" style={{ color: 'var(--accent-cyan)' }}>Chennai (Anna University)</span>
                </p>
    ...
    const aboutCards = [
      ...
      },
      {
        ...
        lines: ['Become a skilled software developer', 'Contribute to innovative technology solutions'],
      },
      {
        icon: 'Sparkles', title: 'Interests',
        lines: ['Frontend Development & Web Technologies', 'Problem solving & exploring new tech'],
      },
    ];
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid lg:grid-cols-5 gap-10 mt-12">
              <div className="lg:col-span-3 space-y-5 leading-relaxed"
                ...
                <p>
                  I am <span className="font-semibold" style={{ color: 'var(--foreground)' }}>Gayathri T</span>, a B.Tech Information Technology student currently pursuing my 3rd year at{' '}
    ...
    const projects = [
      ...
      },
      {
        ...
        description: 'A personal portfolio site showcasing my projects, skills and certifications with a dark cyber-tech aesthetic.',
      ...
      },
      {
        ...
        description: 'An interactive web tool to visualize core data structure operations and algorithms in real time.',
